...
abstract class Factory
{
    ...
    public function getMessageClass(array $jwt): string
    {
        $type = $this->getTypeName($jwt);
        ...
        $typeClaimMap = [
            ...
            LtiConstants::MESSAGE_TYPE_ASSETPROCESSORSETTINGS => AssetProcessorSettingsRequest::class,
            // Notices
