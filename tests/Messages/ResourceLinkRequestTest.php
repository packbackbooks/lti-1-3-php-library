...
{
    private ResourceLinkRequest $resourceLinkRequest;
    ...
    {
        $this->resourceLinkRequest = new ResourceLinkRequest(
            $this->databaseMock,
            $this->cacheMock,
            $this->cookieMock,
        ...
        $this->assertInstanceOf(ResourceLinkRequest::class, $this->resourceLinkRequest);
    }
}
